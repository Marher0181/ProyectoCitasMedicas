...
from Controladores import Doctor, Paciente, Cita, Especialidad, Tratamiento
...
class GestionMedicaApp:
    def __init__(self, root, db):
        ...
        self.controlador_especialidad = Especialidad.ControladorEspecialidad(self.db)
        self.controlador_paciente = Paciente.ControladorPaciente(self.db)
        self.controlador_citas = Cita.ControladorCita(self.db)
        self.controlador_tratamiento = Tratamiento.ContoroladorTratamiento(self.db)
    ...
    def create_widgets(self):
        ...
        button = tk.Button(self.root, text="  Cita", command=self.abrir_ventana_citas, bg="white", fg="#3C372B",
                           font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
                           image=self.imagen_cita)
        button.pack(pady=10)
        buttonu = tk.Button(self.root, text="  Paciente", command=self.abrir_ventana_pacientes, bg="white", fg="#3C372B",
                            font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
                            image=self.imagen_paciente)
        buttonu.pack(pady=10)
        buttonp = tk.Button(self.root, text="  Doctor", command=self.abrir_ventana_doctores, bg="white", fg="#3C372B",
                            font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
                            image=self.imagen_doctor)
        buttonp.pack(pady=10)
        buttonm = tk.Button(self.root, text="  Especialidad", command=self.abrir_ventana_especialidad, bg="white", fg="#3C372B",
                            font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
                            image=self.imagen_especialidad)
        buttonm.pack(pady=10)
        buttonm = tk.Button(self.root, text="  Tratamiento", command=self.abrir_ventana_tratamient, bg="white", fg="#3C372B",
                            font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
                            image=self.imagen_tratamiento)
        buttonm.pack(pady=10)
        buttonm = tk.Button(self.root, text="  Salir", command=self.salir_del_programa, bg="white", fg="#3C372B",
                            font=("Montserrat", 20, "bold italic"), width=340, height=50, compound="left",
    ...
    def abrir_ventana_registrar_paciente(self):
        ...
        def add_paciente():
            ...
            if nombre and edad and contacto and direccion:
                try:
                    self.controlador_paciente.insertar_paciente(nombre, edad, contacto, direccion)
    ...
    def abrir_ventana_modificar_paciente(self):
        ...
        def mod_pac():
            ...
            if entry_id.get() and entry_nombre.get() and entry_edad.get() and entry_contacto.get() and entry_direccion.get():
                try:
                    self.controlador_paciente.modificar_paciente(entry_id.get(), entry_nombre.get(),entry_edad.get(),
                        entry_contacto.get(), entry_direccion.get())
        ...
        def del_cita():
            ...
            if indice != ():
                if messagebox.askokcancel("Advertencia ¿Desea eliminar al paciente?", message=", ".join(listbox.get(i) for i in indice)):
                    id = listbox.get(indice)
                    id = id.split(",")
                    id = id[0]

                self.controlador_paciente.eliminar_paciente(int(id))
    ...
    def abrir_ventana_registrar_doctor(self):
        ...
        def add_doctor():
            ...
            if nombre and especialidad and contacto:
                try:
                    self.controlador_doctor.insertar_doctor(especialidad.get_idEspecialidad(), nombre, contacto)
    ...
    def abrir_ventana_modificar_doctor(self):
        ...
        especialidades = self.controlador_especialidad.obtener_especialidades()
        combo_especialidad['values'] = [es.get_nombreEspecialidad() for es in especialidades]
        combo_especialidad.especialidades = especialidades
        ...
        def add_doctor():
            ...
            if nombre and especialidad and contacto and id:
                try:
                    ...
                    self.controlador_doctor.modificar_doctor(id, especialidad.get_idEspecialidad(), nombre, contacto)
    ...
    def abrir_ventana_eliminar_doctor(self):
        ...
        def del_cita():
            ...
            if indice != ():
                ...
                self.controlador_doctor.eliminar_doctor(id)
    ...
    def abrir_ventana_ver_especialidad(self):
        ...
        listbox = tk.Listbox(ventana, height=15, width=100, fg="#3C372B", font=("Montserrat", 15, "italic"), relief="flat", bd=2)
        listbox.grid(row=2, column=0, pady=5)
        datos = self.controlador_especialidad.obtener_especialidades()
        datostemp = []
        if datos != []:
            for dato in datos:
    ...
    def abrir_ventana_eliminar_especialidad(self):
        ...
        def del_esp():
            ...
            if indice != ():
                ...
                self.controlador_especialidad.eliminar_especialidad(int(id))
                messagebox.showinfo("Éxito", "Especialidad Eliminada Exitosamente.")
                ventana.destroy()

        boton_registrar = tk.Button(ventana, text="   Eliminar Especialidad", command=del_esp, bg="white", fg="#3C372B",
                                    font=("Montserrat", 20, "bold italic"), width=225, height=30, compound="left", image=self.imagen_eliminar)
        boton_registrar.grid(row=5, column=0, pady=5)
    ...
    def abrir_ventana_registrar_especialidad(self):
        ...
        def add_esp():
            ...
            if nombre and des:
                try:
                    self.controlador_especialidad.insertar_especialidad(nombre, des)
    ...
    def abrir_ventana_modificar_especialidad(self):
        ...
        def add_esp():
            ...
            if nombre and des and id:
                try:
                    self.controlador_especialidad.modificar_especialidad(id, nombre, des)
    ...
    def abrir_ventana_registrar_tratamiento(self):
        ...
        def add_tra():
            ...
            if nombre:
                try:
                    self.controlador_tratamiento.insertar_tratamiento(nombre)
    ...
    def abrir_ventana_modificar_tratamiento(self):
        ...
        def add_tra():
            ...
            if nombre and id:
                try:
                    self.controlador_tratamiento.modificar_tratamiento(id, nombre)
    ...
    def abrir_ventana_ver_tratamiento(self):
        ...
        listbox = tk.Listbox(ventana, height=15, width=100, fg="#3C372B", font=("Montserrat", 15, "italic"), relief="flat", bd=2)
        listbox.grid(row=2, column=0, pady=5)
        datos = self.controlador_tratamiento.obtener_Tratamiento()
        datostemp = []
        if datos != []:
            for dato in datos:
    ...
    def abrir_ventana_eliminar_tratamiento(self):
        ...
        def del_esp():
            ...
            if indice != ():
                ...
                self.controlador_tratamiento.eliminar_tratamiento(id)
    ...
    def abrir_ventana_registrar_cita(self):
        ...
        tratamientos = self.controlador_tratamiento.obtener_Tratamiento()
